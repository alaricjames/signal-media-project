  ...
  return (
    <div className="bg-gray-50 py-20">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-12">Expert Web Design Services</h2>
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-lg shadow-lg hover-scale border-t-4 border-purple-600">
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg hover-scale border-t-4 border-pink-600">
            <svg className="h-12 w-12 text-pink-600 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg hover-scale border-t-4 border-indigo-600">
            <svg className="h-12 w-12 text-indigo-600 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
