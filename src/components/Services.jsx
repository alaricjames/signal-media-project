...
const Services = () => {
  return (
    <div id="services" className="py-20 section-alt">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-3xl font-bold text-center mb-12">Our Services</h2>
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="card-surface p-6 rounded-lg border-l-4 border-purple-600">
          ...
          <div className="card-surface p-6 rounded-lg border-l-4 border-pink-600">
          ...
          <div className="card-surface p-6 rounded-lg border-l-4 border-indigo-600">
          ...
          <div className="card-surface p-6 rounded-lg border-l-4 border-blue-600">
