    ...
    <div id="services" className="py-20">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-lg hover-scale border-l-4 border-purple-600 transform hover:scale-105 hover:shadow-xl transition-all duration-300 hover:rotate-1">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg hover-scale border-l-4 border-pink-600 transform hover:scale-105 hover:shadow-xl transition-all duration-300 hover:rotate-1">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg hover-scale border-l-4 border-indigo-600 transform hover:scale-105 hover:shadow-xl transition-all duration-300 hover:rotate-1">
          ...
          <div className="bg-white p-6 rounded-lg shadow-lg hover-scale border-l-4 border-blue-600 transform hover:scale-105 hover:shadow-xl transition-all duration-300 hover:rotate-1">
